...
public class ViewVendas extends javax.swing.JFrame {
    ...
    public ViewVendas() {
        ...
        jtfDesconto.setDocument(new MonetarioDocument());
        //jtfValorTotal.setDocument(new MonetarioDocument());
    }
    ...
    private void initComponents() {
        ...
        jtVendas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Nome Cliente", "Data", "Desconto", "Valor Liquido", "Valor Bruto"
            }
        ) {
            boolean[] canEdit = new boolean [] {
...
/**
 * botão responsavel por salvar um registro de vendas
 * @param evt 
 */
...
/**
 * botão responsavel por excluir um registro de vendas
 * @param evt 
 */
...
/**
 * botão para adicionar um iten no registor do banco de dados da tabela vendas
 * @param evt 
 */
...
/**
 * botão responsavel por criar um novo registro de vendas
 * @param evt 
 */
...
/**
 * botão responsavel por alterar um registro de vendas
 * @param evt 
 */
...
/**
 * botão responsavel por remover um produto da lista de registro de vendas
 * @param evt 
 */
...
/**
 * botão responsavel por chamar a classe Relatorios para gerar um relatorio de vendas de produtos
 * por clientes
 * @param evt 
 */
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String src = "C:/Xratao/src/ireport/grafico.jasper";
...
/**
 * botão responsavel por cancelar uma ação de registro de vendas
 * @param evt 
 */
...
/**
 * botão responsavel por consultar um registro de vendas
 * @param evt 
 */
    ...
    private void carregarVendas() {
        ...
        for (int i = 0; i < cont; i++) {
            modelo.addRow(new Object[]{
                ...
                listaModelVendasClientes.get(i).getModelVendas().getVenDesconto(),
                listaModelVendasClientes.get(i).getModelVendas().getVenValorBruto(),
