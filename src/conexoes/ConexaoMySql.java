/*
* Pacote responsavel pela comunicação com o banco de dados
*/
package conexoes; 
...
public class ConexaoMySql {
    ...
    private static String nomeDoBanco = "pizzariaxratao";
    private static String usuario = "root";
    private static String senha = "2019";
    ...
    public Connection conectar(){
        try {
            ...
            //Class.forName("com.mysql.jdbc.Driver").newInstance(); //Antigo
            
            Class.forName("com.mysql.cj.jdbc.Driver").newInstance(); //Novo

            //local do banco, nome do banco, usuario e senha
            //String url = "jdbc:mysql://" + servidor + "/" + nomeDoBanco;// Versão Workbench 6
            String url = "jdbc:mysql://" + servidor + "/" + nomeDoBanco + "?useTimezone=true&serverTimezone=America/Sao_Paulo"; //Versão Workbench 8
            //String url = "jdbc:mysql://" + servidor + "/" + nomeDoBanco + "?useTimezone=true&serverTimezone=UTC"; //Versão Workbench 8
